...
- *midifilelib.js* is written by me (Minki) and given as a contribution to the convert projects, all rights transferred to surgamingoninsulin/following licencing of the project unless declared otherwise.
