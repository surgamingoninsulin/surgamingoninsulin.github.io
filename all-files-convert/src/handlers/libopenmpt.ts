...
class libopenmptHandler implements FormatHandler {
  ...
  async init(): Promise<void> {
    ...
    const wasmBinary = await fetch(`${import.meta.env.BASE_URL}wasm/libopenmpt.wasm`).then((r) => r.arrayBuffer());
    ...
    const runtimeUrl = `${import.meta.env.BASE_URL}wasm/libopenmpt.js`;
