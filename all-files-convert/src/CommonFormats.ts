...
const CommonFormats = {
  ...
  SVG: new FormatDefinition("Scalable Vector Graphics", "svg", "svg", "image/svg+xml", [
    Category.IMAGE,
    Category.VECTOR,
    Category.DOCUMENT,
  ]),
  ...
  MD: new FormatDefinition("Markdown Document", "markdown", "markdown", "text/markdown", [
    Category.DOCUMENT,
    Category.TEXT,
  ]),
  ...
  WOFF2: new FormatDefinition("Web Open Font Format 2.0", "woff2", "woff2", "font/woff2", [
    Category.FONT,
  ]),
  // music notation
  ...
  TYPST: new FormatDefinition("Typst Document", "typst", "typ", "text/typst", [
    Category.DOCUMENT,
    Category.TEXT,
  ]),
};
